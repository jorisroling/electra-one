...
class Interface  {
  ...
  getParameter(path,kind = 'internal') {  // internal, surface, external, modulated
    ...
    switch (kind) {
    case 'surface':
      result = remap(result,_.get(this.interface.elements,`${path}.min`,_.get(this.interface.elements,`${path}.surface.min`,0)),_.get(this.interface.elements,`${path}.max`,_.get(this.interface.elements,`${path}.surface.max`,127)),_.get(this.interface.elements,`${path}.surface.min`,_.get(this.interface.elements,`${path}.min`,0)),_.get(this.interface.elements,`${path}.surface.max`,_.get(this.interface.elements,`${path}.max`,127)))
      return Math.round(result)
    case 'external':
      result = remap(result,_.get(this.interface.elements,`${path}.min`,_.get(this.interface.elements,`${path}.external.min`,0)),_.get(this.interface.elements,`${path}.max`,_.get(this.interface.elements,`${path}.external.max`,127)),_.get(this.interface.elements,`${path}.external.min`,_.get(this.interface.elements,`${path}.min`,0)),_.get(this.interface.elements,`${path}.external.max`,_.get(this.interface.elements,`${path}.max`,127)))
      return Math.round(result)
    }
    return result
  }
