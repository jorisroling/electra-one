...
const presetStateFilePath = path.resolve((process.env.NODE_ENV == 'production') ? untildify('~/.electra-one/state/bacara.preset.json') : `${__dirname}/../state/bacara.preset.json`)
...
class Bacara {
  ...
  static getPresetState(path,dflt) {
    ...
    return _.get(bacaraPresetState,path,dflt)
  }
